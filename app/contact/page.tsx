  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 leading-relaxed text-center">
        Pour toute question ou assistance,  pas à nous contacter :
      </p>
      ...
      <div className="mt-6 text-center">
        ...
        <p className="text-lg font-semibold">📍 Adresse : <span className="text-blue-600">123 Rue espoir, Nouakchott, Mauritanie</span></p>
      </div>
    </motion.div>
  );
};
