...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-gradient-to-r from-green-600 via-emerald-500 to-lime-400">
      
      {/* Image centrée et affichée entièrement */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Optionnel : léger overlay pour lisibilité */}
        <div className="absolute inset-0 bg-black/30" />
      </div>

      {/* Contenu avec espace pour la navbar */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center text-white px-6 sm:px-8 md:px-10 pt-24 pb-12 min-h-screen">
        <motion.h1
