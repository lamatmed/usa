...
export default function Hero() {
  ...
  return (
    <section className="w-full min-h-screen flex flex-col justify-center items-center text-center bg-gradient-to-r from-green-(00 to-green-700 text-white px-8 md:px-10">
      <motion.div
