...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-r from-green-600 via-emerald-500 to-lime-400 text-white px-6 sm:px-8 md:px-10 py-12 overflow-hidden">

      {/* Image en fond qui occupe tout l'écran */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen pt-20">
        <motion.div
