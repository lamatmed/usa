...
// ✅ Utiliser un typage simple directement ici
...
export default async function ActivityDetailPage({ params }: ActivityPageProps) {
    // ✅ Pas besoin de await ici
    const id = props.params.id; // ✅ Contourne le bug de "params.id should be awaited"
