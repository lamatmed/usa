...
const MembershipCard = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-teal-400 to-blue-500 p-6 sm:p-8">
      <Card
        ref={cardRef}
      ...
      >
        ...
        <CardContent className="flex flex-col items-center text-center mt-4 space-y-4">
          {user.photo && (
            <Image
              src={user.photo}
              alt="Photo de profil"
      ...
      <div className="mt-6 flex gap-4 flex-col sm:flex-row w-full max-w-md">
        <Button
          ...
          onClick={() => handlePrint()}  {/* Call handlePrint without passing an event */}
        >
          Télécharger PDF
        </Button>
        <Button
