      ...
      >
        ...
        <Card className="shadow-sm border-0 rounded-xl overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-100 p-6">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group">
                ...
                <div className="relative inline-flex items-center justify-center w-12 h-12 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all">
                  <Uploader onUpload={(url) => setUser({ ...userp, photo: url })} />
                  <CameraIcon className="absolute h-4 w-4 pointer-events-none" />
                </div>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="address"
                  className="border rounded-xl px-4 py-2 w-full bg-transparent text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  value={userp.address}
                  onChange={handleChange}
              ...
              {/* Emploi */}
              <div>
                <label className="block text-sm font-medium text-gray-200 mb-1">Emploi</label>
                <input
                  type="text"
                  name="job"
                  className="border rounded-xl px-4 py-2 w-full bg-transparent text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-gray-200 mb-1">Domaine</label>
                <input
                  type="text"
                  name="domain"
                  className="border rounded-xl px-4 py-2 w-full bg-transparent text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            {/* Champ CV */}
            <div>
              <label className="block text-sm font-medium text-gray-200 mb-1">CV</label>
              <textarea
                name="cv"
                className="border rounded-xl px-4 py-2 w-full h-32 bg-transparent text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
                value={userp.cv}
                onChange={handleChange}
            ...
            <div className="flex justify-end gap-3 pt-4">
              <Button
                onClick={() => router.push("/dashboard/espace-user")}
                variant="outline"
                className="gap-2 border-gray-500 text-white hover:bg-gray-700"
              >
                Annuler
              </Button>
              <Button
