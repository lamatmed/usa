          ...
          <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-100 p-6">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group">
                ...
                <div className="absolute bottom-0 right-0 p-2 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all cursor-pointer">
  <Uploader
    onUpload={(url) => setUser({ ...userp, photo: url })}
    hideButton={true} // Cache le bouton par défaut de Uploader
  >
