          ...
          <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-100 p-6">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group">
                ...
                <div className="relative inline-flex items-center justify-center w-6 h-12 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all">
