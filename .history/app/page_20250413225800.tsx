...
export default function Hero() {
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-green-600 via-emerald-500 to-lime-400 ">
