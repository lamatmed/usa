...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-gradient-to-br from-green-600 via-emerald-500 to-lime-400">
      {/* Navbar fixée en haut avec bonne visibilité */}
      <nav className="fixed top-0 left-0 w-full z-50 px-4 py-3 flex justify-between items-center bg-white/80 backdrop-blur-md shadow-md">
        <div className="text-lg font-bold text-emerald-700">UDA</div>
        <div className="space-x-4 text-sm md:text-base">
          <a href="/" className="text-emerald-700 hover:underline">Accueil</a>
          <a href="/login" className="text-emerald-700 hover:underline">Connexion</a>
        </div>
      </nav>

      {/* Image pleine largeur/hauteur visible en entier */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Overlay noir semi-transparent pour lisibilité du texte */}
        <div className="absolute inset-0 bg-black/50" />
      </div>

      {/* Contenu centré par-dessus l’image */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center text-white px-4 md:px-10">
        <motion.h1
